...
Params.element = function(params) {
    // passing it into elements as an array since that is what is supported, could duplicate all the contents of the loop but
    return Params.elements([params]);
}
